...
List demoProduct = [
  Product(
      ...
      description:
          'Walk on Air with this full range of iconic classics and modern masterpieces.',
  ...
  Product(
      ...
      description:
          'Elongated lines on the upper bring the 90s look you \nlove into a new, modern space.',
      size: ['US 5', 'US 6', 'US 7'],
      colors: [
        Colors.black,
        Colors.greenAccent,
  ...
  Product(
      ...
      description:
          ' A large, U-shaped Max Air unit provides while a heel clip delivers extra cushioning.',
  ...
  Product(
      ...
      description:
          'Shop Premium Men\'s Leather Sneakers,Classic and Heritage Leathers.',
      size: ['US 3', 'US 5', 'US 8'],
      colors: [
        Colors.red,
        Colors.blue,
